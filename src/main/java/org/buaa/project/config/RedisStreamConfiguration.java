...
import static org.buaa.project.common.consts.RedisCacheConstants.STREAM_GROUP_KEY;
...
public class RedisStreamConfiguration {
    ...
    public Subscription shortLinkStatsSaveConsumerSubscription(ExecutorService asyncStreamConsumer) {
        ...
        StreamMessageListenerContainer.StreamReadRequest<String> streamReadRequest =
                StreamMessageListenerContainer.StreamReadRequest.builder(StreamOffset.create(STREAM_TOPIC_KEY, ReadOffset.lastConsumed()))
                        .cancelOnError(throwable -> false)
                        .consumer(Consumer.from(STREAM_GROUP_KEY, "stats-consumer"))
